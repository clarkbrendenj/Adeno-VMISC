...
AND (((uces.catalog_cd IN (2555537479.00))
    AND (uces.verif_dt_tm BETWEEN cclsql_cnvtdatetimeutc(to_date('{start_time}','YYYY-MM-DD HH24:MI:SS'),1,126,1) AND  cclsql_cnvtdatetimeutc(to_date('{end_time}','YYYY-MM-DD HH24:MI:SS'),1,126,1))
